# Rails 8.1.1 on DigitalOcean

This droplet comes pre-configured with Ruby on Rails 8.1.1 running in Docker containers with PostgreSQL database and Nginx reverse proxy.
...
1. **web**: Rails 8.1.1 application server (Puma)
